  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of dining reservations with OpenT - Your ultimate solution for restaurant bookings, inspired by OpenTable."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of dining reservations with OpenT - Your ultimate solution for restaurant bookings, inspired by OpenTable.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Restaurant Owner" type="restaurant-owner" />
